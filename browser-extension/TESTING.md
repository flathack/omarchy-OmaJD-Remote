...
| HTTPS | Fetch/XHR/script-tag availability probe | `/flash/` and `/jdcheck.js` | Companion reports availability and script load only while the local listener responds |
